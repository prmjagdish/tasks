...
export class AddBrandTable1771484058094 implements MigrationInterface {
    name = 'AddBrandTable1771484058094'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "brands" ADD CONSTRAINT "FK_2b023abd085d111caa06dd5be60" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
